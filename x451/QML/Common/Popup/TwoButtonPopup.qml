...
BasePopup {
    ...
    contentItem: Item {
        ...
        MouseArea{
            anchors.fill: parent
            onPressed: {
                cppUIBase.qmlLog("TwoButtonPopup.qml: Popup Content Item Touched")
        ...
        Image {
            id: idPopupBgOverlay
            source: (prPopupTitle === "") ? "qrc:/image/Popup/PopupBg/PopUp_Backgr_Two_btn/Gen_Gfx_TwoBtn_NoTitle_PopupBgOverlay_n.png"
        ...
        GenericButton {
            ...
            onPressed: {
                cppUIBase.qmlLog("TwoButtonPopup.qml, idFirstBtn: onPressed event received")
                // Deactivate VR session
                cppVRAdaptor.invDeactivateVRSession(HardkeyEnum.HKEY_STATE_RELEASED)
                // Deactivate phone bt vr
                cppPhoneAdaptor.invReqPhoneBtVrDeactivation()
        ...
        GenericButton {
           ...
           onPressed: {
               cppUIBase.qmlLog("TwoButtonPopup.qml, idSecondBtn: onPressed event received")
               // Deactivate VR session
               cppVRAdaptor.invDeactivateVRSession(HardkeyEnum.HKEY_STATE_RELEASED)
               // Deactivate phone bt vr
               cppPhoneAdaptor.invReqPhoneBtVrDeactivation()
        ...
        Connections{
            ...
            onSigRotaryUpdatePopup:{
                cppUIBase.qmlLog("TwoButtonPopup.qml: sigRotaryUpdate: iKeyState: "
            ...
            onSigRotaryPressedPopup:{
                cppUIBase.qmlLog("TwoButtonPopup.qml: onRotaryPressed: "+iKeyState)
