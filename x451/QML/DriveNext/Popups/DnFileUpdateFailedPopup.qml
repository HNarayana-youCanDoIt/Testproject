/**
 * @file            DnFileUpdateFailedPopup.qml
 * @ingroup         QmlPopup
 * @author          Nandkishor Lokhande
 * DnFileUpdateFailedPopup, a popup can use to show DriveNext file update failed starus,
...
NoButtonPopup
{
    ...
    /**
      ...
      */
    prPopupText: qsTr("TEXT_DN_POPUP_FILE_UPDATE_FAILED") + cppThemeMgr.languageChanged
}
