...
TwoButtonPopup {
    ...
    prPopupText: qsTr("TEXT_W3W_POPUP_AUTO_LAUNCH_PERMISSION_AA") + cppThemeMgr.languageChanged
    ...
    onSigFirstBtnReleased: {
        ...
        PopupManager.forceClosePopup(PopupEnum.EN_POPUPID_W3W_ALLOW_AUTOLAUNCH_AA)
        cppAndroidAutoAdaptor.launchAndroidAuto()
        cppW3WAdaptor.invSetAutoLaunchPermissionStatusForAA(true)
    }
