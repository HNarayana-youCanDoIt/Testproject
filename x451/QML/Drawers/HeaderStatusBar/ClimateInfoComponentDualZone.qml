...
Item {
    ...
    /*
     * TextField to show the passenger temperature.
     */
    HBText{
        id: idPassengerTemperatureText

        width: 43
        height: 20

        visible: ((cppHVACAdaptor.errorStatus !== HVACEnums.HVAC_ERROR) &&
                  cppHVACAdaptor.ctrlPanelMode &&
                  !cppHVACAdaptor.xpressCoolMode)

        anchors {
            right: idPassengerDegreeCText.left
         ...
         */
        text: cppHVACAdaptor.passengerTemperature.toFixed(1)+ cppThemeMgr.languageChanged

        fontType: ThemeMgr.FONTTYPE_T24_LIGHT_C2
    }

    /*
 * TextField to show the Degree celsius for passenger temperature.
 */
    HBText{
        id: idPassengerDegreeCText

        anchors{
            right: (idSyncText.visible) ? idSyncText.left : idClimateStatusIcon.left
            top: idPassengerTemperatureText.top
        }
    ...
    HBText{
        ...
        anchors{
            right: idClimateStatusIcon.left
            top: idPassengerDegreeCText.top
        }
        ...
        visible: ((cppHVACAdaptor.errorStatus !== HVACEnums.HVAC_ERROR) &&
                  (cppHVACAdaptor.ctrlPanelMode) &&
                  (cppHVACAdaptor.dualMode) &&
                  !cppHVACAdaptor.xpressCoolMode)

        width: 70
        height: 20

        text: qsTr("Sync") + cppThemeMgr.languageChanged
    ...
    Item {
        ...
        */
        ...
        /*
         * TextField to show the driver temperature.
         */
        HBText{
            id: idDriverTemperatureText
             ...
             * Here we are showing 1 value after decimal
             */
            text: cppHVACAdaptor.driverTemperature.toFixed(1)+ cppThemeMgr.languageChanged
        ...
        /*
     * TextField to show the Degree Celsius for driver temperature.
     */
        HBText{
            id: idDriverDegreeCText

            anchors{
                left: idDriverTemperatureText.right
                top: idDriverTemperatureText.top
            }
