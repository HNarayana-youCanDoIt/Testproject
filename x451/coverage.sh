...
lcov -r "${COV_DIR}/coverage.info" "*Qt*.framework*" "*.h" "*/tests/*" "/usr/include/*" "googlemock/*" "googletest/*" "*Xcode.app*" "*.moc" "*moc_*.cpp" "*/test/*" "*/build*/*" -o "${COV_DIR}/coverage-filtered.info"
...
# Generate XML report
gcovr -r . --xml > ${COV_DIR}/report.xml
 
# Open the index.html
xdg-open "${HTML_RESULTS}/index.html"
echo "End of Coverage Script"
