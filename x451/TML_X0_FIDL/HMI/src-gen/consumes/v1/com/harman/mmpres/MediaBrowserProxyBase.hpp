...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v1::com::harman::mmpres::MMPresTypes::eCallResult&, const uint64_t&, const uint32_t&, const ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel&, const std::string&, const uint64_t&)> GotoNowplayingLevelAsyncCallback;
     ...
     */
    virtual void addToFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> addToFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, AddToFavouriteListAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void deleteFromFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> deleteFromFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, DeleteFromFavouriteListAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
};
