...
public:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, uint64_t &_currPlayingTrackIndex, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    /**
     * description: This interface can be used to add browseItems to Favourite List. 	 	sessionID:
     *   browse session identifier which is currently being used for browsing 	itemID:
     *   Browse item id to be added in favourite list.
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void addToFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> addToFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, AddToFavouriteListAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * description: This interface can be used to delete browseItems from Favourite List. 	
     *   	sessionID: browse session identifier which is currently being used for
     *   browsing 	itemID: Browse item id to be added in favourite list.
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void deleteFromFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> deleteFromFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, DeleteFromFavouriteListAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, uint64_t &_currPlayingTrackIndex, const CommonAPI::CallInfo *_info) {
    delegate_->gotoNowplayingLevel(_sessionID, _slotId, _internalCallStatus, _result, _numItems, _sessionQueryID, _browselevel, _breadcrumbpath, _currPlayingTrackIndex, _info);
}
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::addToFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
    delegate_->addToFavouriteList(_sessionID, _itemID, _internalCallStatus, _result, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::addToFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, AddToFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->addToFavouriteListAsync(_sessionID, _itemID, _callback, _info);
}
/**
 * description: This interface can be used to delete browseItems from Favourite List. 	
 *   	sessionID: browse session identifier which is currently being used for
 ...
 */
template <typename ... _AttributeExtensions>
void MediaBrowserProxy<_AttributeExtensions...>::deleteFromFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
    delegate_->deleteFromFavouriteList(_sessionID, _itemID, _internalCallStatus, _result, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> MediaBrowserProxy<_AttributeExtensions...>::deleteFromFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, DeleteFromFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->deleteFromFavouriteListAsync(_sessionID, _itemID, _callback, _info);
}
