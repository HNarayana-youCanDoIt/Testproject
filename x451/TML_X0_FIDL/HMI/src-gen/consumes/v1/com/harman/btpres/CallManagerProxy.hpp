...
public:
     ...
     *   : dialNumber (String)	        : Number to be dialled 	      : contactName
     *   (String)    	: Contact Name if available 	      : imageUrl (String)	        :
     *   Image URL if available 	returns: errorCode (eErrorType)	: API execution output
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     */
    virtual std::future<CommonAPI::CallStatus> dialAsync(const std::string &_inAddress, const std::string &_dialNumber, const std::string &_contactName, const std::string &_imageUrl, const ::v7::com::harman::btpres::BTPresTypes::eTelType &_numType, DialAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * description: Used to send DTMF tone from head unit to phone.
     * param: inAddress (String)	: BD Address of the device to get the properties 	      :
     *   dtmfTone (String)	: DTMF tone to be sent 	returns: errorCode (errorCode)	: API
     *   execution ouput
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void sendDtmfTone(const std::string &_inAddress, const std::string &_dtmfTone, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     *   upon acceptance 	returns: errorCode (eErrorType): API execution output
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void acceptIncomingCall(const std::string &_inAddress, const bool &_transfer, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * param: inAddress (String)	: BD Address of the device to get the properties 	      :
     *   callId (Int32)          : Call ID of the phone call to be ended 	returns:
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void endCall(const std::string &_inAddress, const int8_t &_callId, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void endActiveCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * param: inAddress (String)	: BD Address of the device to get the properties 	returns:
     *   errorCode (eErrorType): API execution output
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void endAllCalls(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void rejectIncomingCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void holdActiveCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void resumeHeldCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void conferenceCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * param: inAddress (String)	: BD Address of the device to get the properties 	      :
     *   callId (Int32)          : Call ID of the phone call to be selected 	returns:
     *   errorCode (eErrorType): API execution output
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void selectCall(const std::string &_inAddress, const int8_t &_callId, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     *   vise versa
     * param: inAddress (String)	: BD Address of the device to get the properties 	      :
     *   hfMode (Boolean)	: Handsfree Mode requested from the HMI 	returns: errorCode
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void setHfMode(const std::string &_inAddress, const bool &_hfMode, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     * param: inAddress (String)	: BD Address of the device to get the properties 	      :
     *   mode (Boolean)		: VR Mode requested from the HMI 	returns: errorCode
     *   (eErrorType): API execution output
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void setVRMode(const std::string &_inAddress, const bool &_mode, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void swapCalls(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    /**
     * description: This API is used to stop any call manager retry attempts. Retry timer will    
     *   be triggered when there are not response for the call manager request. Retry
     *   attempt will be     made as per the configuration.
     * param: inAddress (String)	: BD Address of the device which to stop retry.  	 	returns:
     *   errorCode (eErrorType): API execution output
     * Calls StopPhoneCmdRetry with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void StopPhoneCmdRetry(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls StopPhoneCmdRetry with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> StopPhoneCmdRetryAsync(const std::string &_inAddress, StopPhoneCmdRetryAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * description: Ignore incoming call. Call will be ignored only from Head Unit and     call can
     *   be accepted on phone.
     * param: inAddress (String)	: BD Address of the device to ignore call. 		returns:
     *   errorCode (eErrorType): API execution output
     * Calls ignoreIncomingCall with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void ignoreIncomingCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls ignoreIncomingCall with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> ignoreIncomingCallAsync(const std::string &_inAddress, IgnoreIncomingCallAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * description: Mute/Unmute incoming call ringtone from HU.
     * param: inAddress (String)	: BD Address of the device to mute incoming call ring.
     * param: mute (Boolean)		: mute or unmute. 		returns: errorCode (eErrorType)	: API
     *   execution output
     * Calls muteIncomingCall with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void muteIncomingCall(const std::string &_inAddress, const bool &_mute, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls muteIncomingCall with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> muteIncomingCallAsync(const std::string &_inAddress, const bool &_mute, MuteIncomingCallAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::sendDtmfTone(const std::string &_inAddress, const std::string &_dtmfTone, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::acceptIncomingCall(const std::string &_inAddress, const bool &_transfer, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::endCall(const std::string &_inAddress, const int8_t &_callId, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::endActiveCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::endAllCalls(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::rejectIncomingCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::holdActiveCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::resumeHeldCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::conferenceCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::selectCall(const std::string &_inAddress, const int8_t &_callId, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::setHfMode(const std::string &_inAddress, const bool &_hfMode, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::setVRMode(const std::string &_inAddress, const bool &_mode, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::swapCalls(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::StopPhoneCmdRetry(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
    delegate_->StopPhoneCmdRetry(_inAddress, _internalCallStatus, _errorCode, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> CallManagerProxy<_AttributeExtensions...>::StopPhoneCmdRetryAsync(const std::string &_inAddress, StopPhoneCmdRetryAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->StopPhoneCmdRetryAsync(_inAddress, _callback, _info);
}
/**
 * description: Ignore incoming call. Call will be ignored only from Head Unit and     call can
 *   be accepted on phone.
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::ignoreIncomingCall(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
    delegate_->ignoreIncomingCall(_inAddress, _internalCallStatus, _errorCode, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> CallManagerProxy<_AttributeExtensions...>::ignoreIncomingCallAsync(const std::string &_inAddress, IgnoreIncomingCallAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->ignoreIncomingCallAsync(_inAddress, _callback, _info);
}
/**
 * description: Mute/Unmute incoming call ringtone from HU.
 * param: inAddress (String)	: BD Address of the device to mute incoming call ring.
 ...
 */
template <typename ... _AttributeExtensions>
void CallManagerProxy<_AttributeExtensions...>::muteIncomingCall(const std::string &_inAddress, const bool &_mute, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info) {
    delegate_->muteIncomingCall(_inAddress, _mute, _internalCallStatus, _errorCode, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> CallManagerProxy<_AttributeExtensions...>::muteIncomingCallAsync(const std::string &_inAddress, const bool &_mute, MuteIncomingCallAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->muteIncomingCallAsync(_inAddress, _mute, _callback, _info);
}
