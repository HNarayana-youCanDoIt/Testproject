...
struct MMPresTypes {
    ...
    struct eSlotType : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SLOTTYPE_SIRITBT):
    ...
    typedef std::unordered_map<::v1::com::harman::mmpres::MMPresTypes::eMetadataType, int64_t, CommonAPI::EnumHasher<::v1::com::harman::mmpres::MMPresTypes::eMetadataType>> FilterIDMap;
    ...
    struct eSessionQueryTypes : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SESSION_QUERY_VR_BROWSE):
                return true;
            default:
                return false;
            }
    ...
    struct tMetadataItem : CommonAPI::Struct<uint64_t, std::string, bool, bool, eFileSystemContentType, eTitleContentType, MetadataCountMap, MetadataStringMap, eMetadataType, std::string, std::string, std::string> {
    	
    	tMetadataItem() {
    		std::get<2>(values_) = false;
    		std::get<3>(values_) = false;
    	}
    	tMetadataItem(const uint64_t &_ID, const std::string &_value, const bool &_playable, const bool &_browsable, const eFileSystemContentType &_folderType, const eTitleContentType &_contentType, const MetadataCountMap &_metadataCountMap, const MetadataStringMap &_metadataMap, const eMetadataType &_itemType, const std::string &_albumName, const std::string &_artistName, const std::string &_genreName)
    	{
    		...
    		std::get<9>(values_) = _albumName;
    		std::get<10>(values_) = _artistName;
    		std::get<11>(values_) = _genreName;
    	}
    	...
    	inline const std::string &getAlbumName() const { return std::get<9>(values_); }
    	inline void setAlbumName(const std::string &_value) { std::get<9>(values_) = _value; }
    	inline const std::string &getArtistName() const { return std::get<10>(values_); }
    	inline void setArtistName(const std::string &_value) { std::get<10>(values_) = _value; }
    	inline const std::string &getGenreName() const { return std::get<11>(values_); }
    	inline void setGenreName(const std::string &_value) { std::get<11>(values_) = _value; }
    	inline bool operator==(const tMetadataItem& _other) const {
                return (getID() == _other.getID() && getValue() == _other.getValue() && getPlayable() == _other.getPlayable() && getBrowsable() == _other.getBrowsable() && getFolderType() == _other.getFolderType() && getContentType() == _other.getContentType() && getMetadataCountMap() == _other.getMetadataCountMap() && getMetadataMap() == _other.getMetadataMap() && getItemType() == _other.getItemType() && getAlbumName() == _other.getAlbumName() && getArtistName() == _other.getArtistName() && getGenreName() == _other.getGenreName());
        }
    	inline bool operator!=(const tMetadataItem &_other) const {
    		return !((*this) == _other);
    	}
    ...
    /**
     * description: Map to provide the sync progress information for a device.
     */
    typedef std::unordered_map<uint32_t, double> SyncProgressMap;
    /**
     * description: Map to provide the playable item availability information for a device.
     */
    typedef std::unordered_map<uint32_t, bool> isPlayableItemAvailableMap;
...
namespace std {
    ...
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::databaseError> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::databaseError& databaseError) const {
            return static_cast<int32_t>(databaseError);
        }
    };
    //Hash for startIndexOption
    template<>
    struct hash<::v1::com::harman::mmpres::MMPresTypes::startIndexOption> {
        inline size_t operator()(const ::v1::com::harman::mmpres::MMPresTypes::startIndexOption& startIndexOption) const {
