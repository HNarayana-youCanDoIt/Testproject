    ...
    struct eEntertainmentSrcs : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SRC_HDD):
    ...
    struct eInterruptSrcs : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SRC_FU_TEL_RINGING):
                ...
                case static_cast<int32_t>(Literal::SRC_BLUETOOTH_VR):
