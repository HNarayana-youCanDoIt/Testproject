...
public:
    ...
    * All non-const parameters will be filled with the returned values.
    ...
    /**
     * description: This function send parameters of Shaping filter. If there is no error it will
     *   return 0. If not it will return -1.
     * Calls sendShapingFilter with synchronous semantics.
     * 
    * All const parameters are input parameters to this method.
    * All non-const parameters will be filled with the returned values.
     * The CallStatus will be filled when the method returns and indicate either
     ...
     * will be set.
     */
    virtual void sendShapingFilter(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, CommonAPI::CallStatus &_internalCallStatus, ::v3::org::genivi::am_t::am_Error_e &_qhError, const CommonAPI::CallInfo *_info = nullptr);
    /**
     * Calls sendShapingFilter with asynchronous semantics.
     * 
     * The provided callback will be called when the reply to this call arrives or
     * an error occurs during the call. The CallStatus will indicate either "SUCCESS"
     * or which type of error has occurred. In case of any error, ONLY the CallStatus
     ...
     * It will provide the same value for CallStatus as will be handed to the callback.
     */
    virtual std::future<CommonAPI::CallStatus> sendShapingFilterAsync(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, SendShapingFilterAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
    /**
 ...
 */
template <typename ... _AttributeExtensions>
void RoutingControlObserverProxy<_AttributeExtensions...>::sendShapingFilter(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, CommonAPI::CallStatus &_internalCallStatus, ::v3::org::genivi::am_t::am_Error_e &_qhError, const CommonAPI::CallInfo *_info) {
    delegate_->sendShapingFilter(_bsFilter, _internalCallStatus, _qhError, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> RoutingControlObserverProxy<_AttributeExtensions...>::sendShapingFilterAsync(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, SendShapingFilterAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->sendShapingFilterAsync(_bsFilter, _callback, _info);
}
/**
 * description: This function send parameters of delay time. If there is no error it will
 *   return 0. If not it will return -1.
