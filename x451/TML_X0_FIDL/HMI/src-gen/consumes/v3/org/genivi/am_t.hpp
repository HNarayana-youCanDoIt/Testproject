...
struct am_t {
    ...
    struct am_SystemPropertyType_e : CommonAPI::Enumeration<int32_t> {
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SYS_PDC_MIX_MODE):
    ...
    struct am_CustomSoundPropertyType_e : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            ...
            SP_GENIVI_PROMPT_ATTENUATE_PARAM = 39,
            SP_GENIVI_MIX_MODE = 40,
            SP_GENIVI_PDC_CONTROL = 41,
            SP_GENIVI_DAB_VARIANT = 42,
            SP_GENIVI_LAST_SOURCE_STATE = 43,
            SP_GENIVI_CANCEL_DUCKING = 44,
            SP_GENIVI_SOURCE_FAST_MUTE = 45,
            SP_MAX = 46
        };
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::SP_GENIVI_RESERVED):
                ...
                case static_cast<int32_t>(Literal::SP_GENIVI_PROMPT_ATTENUATE_PARAM):
                case static_cast<int32_t>(Literal::SP_GENIVI_MIX_MODE):
                case static_cast<int32_t>(Literal::SP_GENIVI_PDC_CONTROL):
                case static_cast<int32_t>(Literal::SP_GENIVI_DAB_VARIANT):
                case static_cast<int32_t>(Literal::SP_GENIVI_LAST_SOURCE_STATE):
                case static_cast<int32_t>(Literal::SP_GENIVI_CANCEL_DUCKING):
                case static_cast<int32_t>(Literal::SP_GENIVI_SOURCE_FAST_MUTE):
    ...
    struct am_sourceID_e : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            ...
            eSRC_FU_IPOD2 = 108,
            eSRC_TUNER_AA = 109,
            eSRC_TUNER_DAB_AA = 110,
            eSRC_TUNER_DAB_NEWS = 111,
            eSRC_APPLINK_MEDIA1 = 112,
            eSRC_APPLINK_MEDIA2 = 113,
            eSRC_APPLINK_MEDIA3 = 114,
            eSRC_APPLINK_MEDIA4 = 115,
            eSRC_DTMF = 116,
            eSRC_HMI_TTS = 117,
            eSRC_X_CALL = 118,
            eSRC_AAS = 119,
            eSRC_WELCOME = 120,
            eSRC_ONLINE_STREAM = 121,
            eSRC_PEDESTRIAN_CROSSING_SOUND = 122,
            eSRC_VA_INTERNAL = 123,
            eSRC_VA_EXTERNAL = 124,
            eSRC_GOODBYE = 125,
            eSRC_MAX = 126
        };
        ...
        inline bool validate() const {
            switch (value_) {
                ...
                case static_cast<int32_t>(Literal::eSRC_TUNER_AA):
                case static_cast<int32_t>(Literal::eSRC_TUNER_DAB_AA):
                case static_cast<int32_t>(Literal::eSRC_TUNER_DAB_NEWS):
                case static_cast<int32_t>(Literal::eSRC_APPLINK_MEDIA1):
                case static_cast<int32_t>(Literal::eSRC_APPLINK_MEDIA2):
                case static_cast<int32_t>(Literal::eSRC_APPLINK_MEDIA3):
                case static_cast<int32_t>(Literal::eSRC_APPLINK_MEDIA4):
                case static_cast<int32_t>(Literal::eSRC_DTMF):
                case static_cast<int32_t>(Literal::eSRC_HMI_TTS):
                case static_cast<int32_t>(Literal::eSRC_X_CALL):
                case static_cast<int32_t>(Literal::eSRC_AAS):
                case static_cast<int32_t>(Literal::eSRC_WELCOME):
                case static_cast<int32_t>(Literal::eSRC_ONLINE_STREAM):
                case static_cast<int32_t>(Literal::eSRC_PEDESTRIAN_CROSSING_SOUND):
                case static_cast<int32_t>(Literal::eSRC_VA_INTERNAL):
                case static_cast<int32_t>(Literal::eSRC_VA_EXTERNAL):
                case static_cast<int32_t>(Literal::eSRC_GOODBYE):
    ...
    struct am_MixMode_Type_e : CommonAPI::Enumeration<int32_t> {
        enum Literal : int32_t {
            AM_MIX_MODE_UNKNOWN = -1,
            AM_MIX_MODE_DISABLE = 0,
            AM_MIX_MODE_ENABLE = 1,
            AM_MIX_MODE_MAX = 3
        };
        
        am_MixMode_Type_e() 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(Literal::AM_MIX_MODE_UNKNOWN)) {}
        am_MixMode_Type_e(Literal _literal) 
            : CommonAPI::Enumeration<int32_t>(static_cast<int32_t>(_literal)) {}
    
        inline bool validate() const {
            switch (value_) {
                case static_cast<int32_t>(Literal::AM_MIX_MODE_UNKNOWN):
                case static_cast<int32_t>(Literal::AM_MIX_MODE_DISABLE):
                case static_cast<int32_t>(Literal::AM_MIX_MODE_ENABLE):
                case static_cast<int32_t>(Literal::AM_MIX_MODE_MAX):
                return true;
            default:
                return false;
            }
        ...
        inline bool operator==(const am_MixMode_Type_e &_other) const { return (value_ == _other.value_); }
        inline bool operator!=(const am_MixMode_Type_e &_other) const { return (value_ != _other.value_); }
        inline bool operator<=(const am_MixMode_Type_e &_other) const { return (value_ <= _other.value_); }
        inline bool operator>=(const am_MixMode_Type_e &_other) const { return (value_ >= _other.value_); }
        inline bool operator<(const am_MixMode_Type_e &_other) const { return (value_ < _other.value_); }
     ...
     */
    struct hq_limiterStruct_s : CommonAPI::Struct<hq_uInt8_t, hq_float32_t, hq_float32_t, hq_float32_t, hq_float32_t, hq_float32_t, hq_float32_t> {
    	
    	hq_limiterStruct_s() {
    	}
    	hq_limiterStruct_s(const hq_uInt8_t &_channel, const hq_float32_t &_gain, const hq_float32_t &_threshold, const hq_float32_t &_attackTime, const hq_float32_t &_releaseTime, const hq_float32_t &_holdThreshold, const hq_float32_t &_holdTime)
    	{
    	 ...
    	 */
    	inline const hq_float32_t &getThreshold() const { return std::get<2>(values_); }
    	inline void setThreshold(const hq_float32_t &_value) { std::get<2>(values_) = _value; }
    	/**
     ...
     * description: This struct describes the attributes of a limiter.
     */
    struct hq_eqFilterStruct_s : CommonAPI::Struct<hq_uInt8_t, hq_uInt16_t, hq_float32_t, hq_float32_t, hq_uInt8_t, hq_uInt8_t> {
    	
    	hq_eqFilterStruct_s() {
    	}
    	hq_eqFilterStruct_s(const hq_uInt8_t &_bandIndex, const hq_uInt16_t &_frequency, const hq_float32_t &_gain, const hq_float32_t &_quality, const hq_uInt8_t &_type, const hq_uInt8_t &_order)
    	{
     ...
     */
    struct hq_londnessStruct_s : CommonAPI::Struct<hq_float32_t, hq_float32_t, hq_float32_t, hq_float32_t> {
    	
    	hq_londnessStruct_s() {
    	}
    	hq_londnessStruct_s(const hq_float32_t &_volumeLow, const hq_float32_t &_volumeHigh, const hq_float32_t &_gainLow, const hq_float32_t &_gainHigh)
    	{
    	 ...
    	 */
    	inline const hq_float32_t &getVolumeLow() const { return std::get<0>(values_); }
    	inline void setVolumeLow(const hq_float32_t &_value) { std::get<0>(values_) = _value; }
    	/**
    	 * description: This is the treble volume of londness.
    	 */
    	inline const hq_float32_t &getVolumeHigh() const { return std::get<1>(values_); }
    	inline void setVolumeHigh(const hq_float32_t &_value) { std::get<1>(values_) = _value; }
    	/**
    	 * description: This is the bass addition gain of londness.
    	 */
    	inline const hq_float32_t &getGainLow() const { return std::get<2>(values_); }
    	inline void setGainLow(const hq_float32_t &_value) { std::get<2>(values_) = _value; }
    	/**
    	 * description: This is the treble addition gain of londness.
    	 */
    	inline const hq_float32_t &getGainHigh() const { return std::get<3>(values_); }
    	inline void setGainHigh(const hq_float32_t &_value) { std::get<3>(values_) = _value; }
...
namespace std {
    ...
    //Hash for am_MixMode_Type_e
    template<>
    struct hash<::v3::org::genivi::am_t::am_MixMode_Type_e> {
        inline size_t operator()(const ::v3::org::genivi::am_t::am_MixMode_Type_e& am_MixMode_Type_e) const {
            return static_cast<int32_t>(am_MixMode_Type_e);
        }
    };
