...
public:
    ...
    /**
     * description: RestartReasonExtended: This property informs clients about the reason for the
     *   last restart. The values are strings defined by CPM
     */
    /**
     * Returns the wrapper class that provides access to the attribute RestartReasonExtended.
     */
    virtual RestartReasonExtendedAttribute& getRestartReasonExtendedAttribute() {
        return delegate_->getRestartReasonExtendedAttribute();
    }
    /**
    ...
    /**
     * description: ShutdownReasonExtended: This property informs clients about the reason for the
     *   last shutdown. The values are strings defined by CPM
     */
    /**
     * Returns the wrapper class that provides access to the attribute ShutdownReasonExtended.
     */
    virtual ShutdownReasonExtendedAttribute& getShutdownReasonExtendedAttribute() {
        return delegate_->getShutdownReasonExtendedAttribute();
    }
    /**
    ...
    /**
     * description: WakeUpReasonExtended: This property informs clients about the recent reason for
     *   waking up the target. The values are strings defined by CPM
     */
    /**
     * Returns the wrapper class that provides access to the attribute WakeUpReasonExtended.
     */
    virtual WakeUpReasonExtendedAttribute& getWakeUpReasonExtendedAttribute() {
        return delegate_->getWakeUpReasonExtendedAttribute();
    }
    /**
    ...
    /**
     * description: PowerModeTransition: This property informs clients about the current PowerMode
     *   of the target. The values will be updates as soon as the power master changes
     *   the state. 	   basic PowerMode States are
     *   ACTIVE,STANDBY,SLEEP,SHUTDOWN,ENTERTAINMENT_MODE as well as Power Mode
     *   Transition Triggers in structure NsmPowerModeTransition
     */
    /**
     * Returns the wrapper class that provides access to the attribute PowerModeTransition.
     */
    virtual PowerModeTransitionAttribute& getPowerModeTransitionAttribute() {
        return delegate_->getPowerModeTransitionAttribute();
    }
     ...
     *   with the below values 	       ( 	       	NSM_SHUTDOWNTYPE_SEQUENTIAL_NORMAL =
     *   1 	    	NSM_SHUTDOWNTYPE_SEQUENTIAL_FAST   = 2    		    	    		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_NORMAL   = 5  		    NSM_SHUTDOWNTYPE_PARALLEL_FAST  
     *     = 6   	  		    NSM_SHUTDOWNTYPE_SEQENTIAL_RUNUP   = 2147483648	 		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_RUNUP    = 2147483652		     		    )         
     *   	Selective broadcast of shutdown request to registered clients     	This
     *   signal is sent to registered clients when shutdown state is received
     *   		Note:LifeCycleRequest signal renamed to ShutdownEvent and RequestID is
     *   removed
     * author: Giridhar
     */
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     *   to be informed (     		i.e 	       	     		NSM_SHUTDOWNTYPE_SEQUENTIAL_NORMAL 
     *             = 1 	    	NSM_SHUTDOWNTYPE_SEQUENTIAL_FAST              = 2 	       
     *   NSM_SHUTDOWNTYPE_SEQUENTIAL_NORMAL_AND_FAST   = 3	    	    		    	    		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_NORMAL              = 5  		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_FAST                = 6   	 		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_NORMAL_AND_FAST     = 7		      	).     	TimeoutMs:  
     *    Max. Timeout to wait for response from shutdown client in ms.     	ErrorCode:
     *      Return value passed to the caller, based upon NsmErrorStatus_e.         
     *   	The method is used by other applications to register themselves as shutdown
     *   client. Any client that registers must provide a method in their D-Bus object
     *   called "LifecycleRequest". This method will take one parameter which is the
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     *   wants to unregister      	 (     		i.e 	       	    
     *   		NSM_SHUTDOWNTYPE_SEQUENTIAL_NORMAL            = 1 	   
     *   	NSM_SHUTDOWNTYPE_SEQUENTIAL_FAST              = 2 	       
     *   NSM_SHUTDOWNTYPE_SEQUENTIAL_NORMAL_AND_FAST   = 3	    	    		    	    		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_NORMAL              = 5  		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_FAST                = 6   	 		   
     *   NSM_SHUTDOWNTYPE_PARALLEL_NORMAL_AND_FAST     = 7		      	).     	ErrorCode:  
     *    Return value passed to the caller, based upon NsmErrorStatus_e.          	The
     *   method is used by other applications to unregister themselves as shutdown
     *   client.  		Removed Below Parameters:  		BusName:      Bus name of remote
     *   application.     	ObjName:      Object name of remote object that provides the
     *   shutdown interface.
     * author: Giridhar
...
namespace ConsumerExtensions {
     ...
     */
    template <template <typename > class _ExtensionType>
    class RestartReasonExtendedAttributeExtension {
     public:
        typedef _ExtensionType<ConsumerProxyBase::RestartReasonExtendedAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<ConsumerProxyBase::RestartReasonExtendedAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        RestartReasonExtendedAttributeExtension() {}
    #endif
    
        RestartReasonExtendedAttributeExtension(ConsumerProxyBase& proxy): attributeExtension_(proxy.getRestartReasonExtendedAttribute()) {
        }
    
        inline extension_type& getRestartReasonExtendedAttributeExtension() {
            return attributeExtension_;
        }
     ...
     */
    template <template <typename > class _ExtensionType>
    class ShutdownReasonExtendedAttributeExtension {
     public:
        typedef _ExtensionType<ConsumerProxyBase::ShutdownReasonExtendedAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<ConsumerProxyBase::ShutdownReasonExtendedAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        ShutdownReasonExtendedAttributeExtension() {}
    #endif
    
        ShutdownReasonExtendedAttributeExtension(ConsumerProxyBase& proxy): attributeExtension_(proxy.getShutdownReasonExtendedAttribute()) {
        }
    
        inline extension_type& getShutdownReasonExtendedAttributeExtension() {
            return attributeExtension_;
        }
     ...
     */
    template <template <typename > class _ExtensionType>
    class WakeUpReasonExtendedAttributeExtension {
     public:
        typedef _ExtensionType<ConsumerProxyBase::WakeUpReasonExtendedAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<ConsumerProxyBase::WakeUpReasonExtendedAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        WakeUpReasonExtendedAttributeExtension() {}
    #endif
    
        WakeUpReasonExtendedAttributeExtension(ConsumerProxyBase& proxy): attributeExtension_(proxy.getWakeUpReasonExtendedAttribute()) {
        }
    
        inline extension_type& getWakeUpReasonExtendedAttributeExtension() {
            return attributeExtension_;
        }
     ...
     */
    template <template <typename > class _ExtensionType>
    class PowerModeTransitionAttributeExtension {
     public:
        typedef _ExtensionType<ConsumerProxyBase::PowerModeTransitionAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension<ConsumerProxyBase::PowerModeTransitionAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    #ifdef WIN32
        PowerModeTransitionAttributeExtension() {}
    #endif
    
        PowerModeTransitionAttributeExtension(ConsumerProxyBase& proxy): attributeExtension_(proxy.getPowerModeTransitionAttribute()) {
        }
    
        inline extension_type& getPowerModeTransitionAttributeExtension() {
            return attributeExtension_;
        }
...
struct DefaultAttributeProxyHelper<::v2::org::genivi::NodeStateManager::ConsumerProxy,
    ...
    typedef typename ::v2::org::genivi::NodeStateManager::ConsumerProxy<
            ...
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::RestartReasonExtendedAttributeExtension<_AttributeExtension>, 
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::ShutdownReasonAttributeExtension<_AttributeExtension>, 
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::ShutdownReasonExtendedAttributeExtension<_AttributeExtension>, 
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::WakeUpReasonAttributeExtension<_AttributeExtension>, 
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::WakeUpReasonExtendedAttributeExtension<_AttributeExtension>, 
            ...
            ::v2::org::genivi::NodeStateManager::ConsumerExtensions::PowerModeTransitionAttributeExtension<_AttributeExtension>
    > class_t;
};
}
