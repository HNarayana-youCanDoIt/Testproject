...
public:
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::eBluetoothStatus> BtStateAttribute;
    ...
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::tDeviceSearchEntryList> DevSearchResultsAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::bondedDevList> DevListAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::bondedDevList> ConnectedDevListAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::networkIfStatus> NetIfStatusAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::unstableDeviceInfoList> UnstableDevsAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<std::string> PrimaryDeviceAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::dontDisturbDeviceInfo> DnDStatusAttribute;
    typedef CommonAPI::ObservableReadonlyAttribute<::v7::com::harman::btpres::BTPresTypes::extendedDnd> DndInfoAttribute;
    typedef CommonAPI::ObservableAttribute<bool> SocialModeStatusAttribute;
    typedef CommonAPI::Event<
        std::string, std::string, ::v7::com::harman::btpres::BTPresTypes::eBondingType, std::string
    > BondingRequestEvent;
    typedef CommonAPI::Event<
        std::string, std::string, ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile
    > ServiceConnectionRequestEvent;
    typedef CommonAPI::Event<
        std::string, std::string, ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile, ::v7::com::harman::btpres::BTPresTypes::eConnectionStatus, ::v7::com::harman::btpres::BTPresTypes::eServiceConnectDisconnectReason
    > ServiceConnectionStatusEvent;
    typedef CommonAPI::Event<
        std::string, std::string, ::v7::com::harman::btpres::BTPresTypes::eDeviceDeletedReason
    > DeviceDeletedEvent;
    typedef CommonAPI::Event<
        ::v7::com::harman::btpres::BTPresTypes::deviceInfo
    > ReconnectionFailedEvent;
    typedef CommonAPI::Event<
        std::string, std::string, ::v7::com::harman::btpres::BTPresTypes::ePairingStatus
    > BondingStatusEvent;
    typedef CommonAPI::Event<
        ::v7::com::harman::btpres::BTPresTypes::uToneID, bool
    > TonePlayStateEvent;

    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StartDeviceSearchAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StopDeviceSearchAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> BondingReplyAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> DeleteDeviceAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> DeleteAllDevicesAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StartServiceConnectionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> AllowServiceConnectionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StartServiceDisconnectionAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> ServiceConnectionReplyAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StartReconnectAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&, const ::v7::com::harman::btpres::BTPresTypes::deviceInfo&)> GetOldestConnectedDevAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> RenameBondedDeviceAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> RenameLocalDeviceAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> SetBluetoothStatusAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> SetDiscoverableModeAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> SetPinAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> SetPrimaryDeviceAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&, const std::string&, const ::v7::com::harman::btpres::BTPresTypes::eSettingsProperty&, const ::v7::com::harman::btpres::BTPresTypes::settingsValues&)> PhoneSettingsAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> DontDisturbAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> DontDisturbExtendedAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> SetFavoriteDeviceAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> PlayAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> StopAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&, const ::v7::com::harman::btpres::BTPresTypes::deviceDetails&)> GetBondedDeviceDetailsAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::eErrorType&)> FactoryResetAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const ::v7::com::harman::btpres::BTPresTypes::radioStrengthInfoList&)> GetRadioStrengthAsyncCallback;
     ...
     */
    virtual SocialModeStatusAttribute& getSocialModeStatusAttribute() = 0;
     ...
     */
    virtual void startDeviceSearch(const uint32_t &_maxDevice, const uint32_t &_timeout, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void stopDeviceSearch(CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   returns: errorCode (eErrorType) : error code
     */
    virtual void bondingReply(const std::string &_inAddress, const bool &_accept, const bool &_trusted, const ::v7::com::harman::btpres::BTPresTypes::eBondingType &_type, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> bondingReplyAsync(const std::string &_inAddress, const bool &_accept, const bool &_trusted, const ::v7::com::harman::btpres::BTPresTypes::eBondingType &_type, BondingReplyAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void deleteDevice(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void deleteAllDevices(CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    ...
    virtual std::future<CommonAPI::CallStatus> startServiceConnectionAsync(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::arSupportedProfile &_ProfileList, const std::string &_replaceAddr, StartServiceConnectionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void allowServiceConnection(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile &_service, const bool &_allow, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> allowServiceConnectionAsync(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile &_service, const bool &_allow, AllowServiceConnectionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void startServiceDisconnection(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile &_service, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> startServiceDisconnectionAsync(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::eSupportedProfile &_service, StartServiceDisconnectionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     * description: Used to initate the disconnection with connected service i.e. HFP and A2DP
     * param: inAddress (string)                  : phone BT address
     ...
     */
    virtual void startServiceDisconnection(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::arSupportedProfile &_ProfileList, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> startServiceDisconnectionAsync(const std::string &_inAddress, const ::v7::com::harman::btpres::BTPresTypes::arSupportedProfile &_ProfileList, StartServiceDisconnectionAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void startReconnect(CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void getOldestConnectedDev(CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, ::v7::com::harman::btpres::BTPresTypes::deviceInfo &_oldestDevInfo, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   : error code
     */
    virtual void renameBondedDevice(const std::string &_inAddress, const std::string &_name, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   : error code
     */
    virtual void renameLocalDevice(const std::string &_name, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void setBluetoothStatus(const bool &_status, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   (eErrorType) : error code
     */
    virtual void setDiscoverableMode(const bool &_enabled, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void setPin(const std::string &_passkey, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   code (eErrorType) : error code
     */
    virtual void setPrimaryDevice(const std::string &_inAddress, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   API
     */
    virtual void DontDisturb(const ::v7::com::harman::btpres::BTPresTypes::dontDisturbDeviceInfo &_device, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> DontDisturbAsync(const ::v7::com::harman::btpres::BTPresTypes::dontDisturbDeviceInfo &_device, DontDisturbAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     *   (eErrorType)       : error code
     */
    virtual void DontDisturbExtended(const ::v7::com::harman::btpres::BTPresTypes::extendedDnd &_dndMode, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> DontDisturbExtendedAsync(const ::v7::com::harman::btpres::BTPresTypes::extendedDnd &_dndMode, DontDisturbExtendedAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     *   error code (eErrorType) : error code
     */
    virtual void SetFavoriteDevice(const std::string &_address, const uint16_t &_index, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   (eErrorType) : error code
     */
    virtual void play(const ::v7::com::harman::btpres::BTPresTypes::uToneID &_toneID, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> playAsync(const ::v7::com::harman::btpres::BTPresTypes::uToneID &_toneID, PlayAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     *   (eErrorType) : error code
     */
    virtual void stop(const ::v7::com::harman::btpres::BTPresTypes::uToneID &_ringID, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> stopAsync(const ::v7::com::harman::btpres::BTPresTypes::uToneID &_ringID, StopAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void getBondedDeviceDetails(const std::string &_address, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, ::v7::com::harman::btpres::BTPresTypes::deviceDetails &_device, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     *   : error code
     */
    virtual void factoryReset(const ::v7::com::harman::btpres::BTPresTypes::factroyResetType &_type, CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::eErrorType &_errorCode, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> factoryResetAsync(const ::v7::com::harman::btpres::BTPresTypes::factroyResetType &_type, FactoryResetAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     * description: This will be used to get the radio strength of Bluetooth device connected to HU.
     */
    virtual void getRadioStrength(CommonAPI::CallStatus &_internalCallStatus, ::v7::com::harman::btpres::BTPresTypes::radioStrengthInfoList &_radioStrengthList, const CommonAPI::CallInfo *_info = nullptr) = 0;
