...
public:
     ...
     */
    virtual void addToFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> addToFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, AddToFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
     ...
     */
    virtual void deleteFromFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> deleteFromFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, DeleteFromFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info);
