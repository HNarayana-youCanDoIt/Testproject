...
_result = deploy_result.getValue();
    ...
    void MediaBrowserDBusProxy::gotoNowplayingLevel(const uint32_t &_sessionID, const uint8_t &_slotId, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, uint64_t &_numItems, uint32_t &_sessionQueryID, ::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel &_browselevel, std::string &_breadcrumbpath, uint64_t &_currPlayingTrackIndex, const CommonAPI::CallInfo *_info) {
        ...
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel, CommonAPI::EmptyDeployment> deploy_browselevel(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> deploy_breadcrumbpath(static_cast<CommonAPI::DBus::StringDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_currPlayingTrackIndex(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >,
            CommonAPI::Deployable<uint8_t, CommonAPI::EmptyDeployment >
...
_internalCallStatus,
deploy_result, deploy_numItems, deploy_sessionQueryID, deploy_browselevel, deploy_breadcrumbpath, deploy_currPlayingTrackIndex);
_result = deploy_result.getValue();
_numItems = deploy_numItems.getValue();
_sessionQueryID = deploy_sessionQueryID.getValue();
_browselevel = deploy_browselevel.getValue();
_breadcrumbpath = deploy_breadcrumbpath.getValue();
_currPlayingTrackIndex = deploy_currPlayingTrackIndex.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::gotoNowplayingLevelAsync(const uint32_t &_sessionID, const uint8_t &_slotId, GotoNowplayingLevelAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        ...
        *this,
        ...
        (_info ? _info : &CommonAPI::DBus::defaultCallInfo),
        deploy_sessionID, deploy_slotId,
        [_callback] (CommonAPI::CallStatus _internalCallStatus, CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> _result, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _numItems, CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> _sessionQueryID, CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::ePrevBrowseLevel, CommonAPI::EmptyDeployment> _browselevel, CommonAPI::Deployable<std::string, CommonAPI::DBus::StringDeployment> _breadcrumbpath, CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> _currPlayingTrackIndex) {
        	if (_callback)
        		_callback(_internalCallStatus, _result.getValue(), _numItems.getValue(), _sessionQueryID.getValue(), _browselevel.getValue(), _breadcrumbpath.getValue(), _currPlayingTrackIndex.getValue());
        },
        std::make_tuple(deploy_result, deploy_numItems, deploy_sessionQueryID, deploy_browselevel, deploy_breadcrumbpath, deploy_currPlayingTrackIndex));
    }
    /**
     ...
     */
    void MediaBrowserDBusProxy::addToFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_itemID(_itemID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment >,
        ...
        *this,
        ...
        "ut",
(_info ? _info : &CommonAPI::DBus::defaultCallInfo),
deploy_sessionID, deploy_itemID,
_internalCallStatus,
deploy_result);
_result = deploy_result.getValue();
}
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::addToFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, AddToFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_itemID(_itemID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
     ...
     */
    void MediaBrowserDBusProxy::deleteFromFavouriteList(const uint32_t &_sessionID, const uint64_t &_itemID, CommonAPI::CallStatus &_internalCallStatus, ::v1::com::harman::mmpres::MMPresTypes::eCallResult &_result, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_itemID(_itemID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
...
_result = deploy_result.getValue();
    ...
    std::future<CommonAPI::CallStatus> MediaBrowserDBusProxy::deleteFromFavouriteListAsync(const uint32_t &_sessionID, const uint64_t &_itemID, DeleteFromFavouriteListAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<uint32_t, CommonAPI::EmptyDeployment> deploy_sessionID(_sessionID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<uint64_t, CommonAPI::EmptyDeployment> deploy_itemID(_itemID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v1::com::harman::mmpres::MMPresTypes::eCallResult, CommonAPI::EmptyDeployment> deploy_result(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
