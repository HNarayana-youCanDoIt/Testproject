...
,		restartReason_(*this, "onRestartReasonAttributeChanged", "i", "getRestartReasonAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		restartReasonExtended_(*this, "onRestartReasonExtendedAttributeChanged", "s", "getRestartReasonExtendedAttribute", static_cast<CommonAPI::DBus::StringDeployment*>(nullptr)),
		...
		shutdownReasonExtended_(*this, "onShutdownReasonExtendedAttributeChanged", "s", "getShutdownReasonExtendedAttribute", static_cast<CommonAPI::DBus::StringDeployment*>(nullptr)),
		...
		wakeUpReasonExtended_(*this, "onWakeUpReasonExtendedAttributeChanged", "s", "getWakeUpReasonExtendedAttribute", static_cast<CommonAPI::DBus::StringDeployment*>(nullptr)),
		...
		powerModeTransition_(*this, "onPowerModeTransitionAttributeChanged", "(si)", "getPowerModeTransitionAttribute", static_cast<::v2::org::genivi::NodeStateManager::NodeStateTypes_::NsmPowerModeTransitionDeployment_t*>(nullptr))
		...
		shutdownEventSelective_(*this, "ShutdownEvent", "u", std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr)))
{
      ...
      ConsumerDBusProxy::RestartReasonExtendedAttribute& ConsumerDBusProxy::getRestartReasonExtendedAttribute() {
          return restartReasonExtended_;
      }
      ConsumerDBusProxy::ShutdownReasonAttribute& ConsumerDBusProxy::getShutdownReasonAttribute() {
          return shutdownReason_;
      }
      ConsumerDBusProxy::ShutdownReasonExtendedAttribute& ConsumerDBusProxy::getShutdownReasonExtendedAttribute() {
          return shutdownReasonExtended_;
      }
      ConsumerDBusProxy::WakeUpReasonAttribute& ConsumerDBusProxy::getWakeUpReasonAttribute() {
          return wakeUpReason_;
      }
      ConsumerDBusProxy::WakeUpReasonExtendedAttribute& ConsumerDBusProxy::getWakeUpReasonExtendedAttribute() {
          return wakeUpReasonExtended_;
      }
      ...
      ConsumerDBusProxy::PowerModeTransitionAttribute& ConsumerDBusProxy::getPowerModeTransitionAttribute() {
          return powerModeTransition_;
      }
