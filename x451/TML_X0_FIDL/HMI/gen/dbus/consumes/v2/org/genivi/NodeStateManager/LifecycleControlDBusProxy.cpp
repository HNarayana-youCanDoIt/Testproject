	...
	:	CommonAPI::DBus::DBusProxy(_address, _connection)
{
    ...
    /**
     * description: RequestNodeRestart:     	RestartReason: The passed value will be based upon the
     *   enum NsmRestartReason_e.     	RestartType:   This is the type of restart that
     ...
     *   NsmErrorStatus_e.      	The method is used by other applications to request a
     *   restart of the node.
     * author: Giridhar
     */
...
_ErrorCode = deploy_ErrorCode.getValue();
    ...
    /**
     * description: SetApplicationMode:     	ApplicationModeId: This parameter will be based upon
     *   the NsmNodeApplicationMode_e.     	ErrorCode:         Return value passed to
     *   the caller, based upon NsmErrorStatus_e.     	The method is used by other
...
_ErrorCode = deploy_ErrorCode.getValue();
    ...
    /**
     * description: SetNodeState:     	NodeStateId: The passed value will be based upon the enum
     *   NsmNodeState_e.     	ErrorCode:   Return value passed to the caller, based
     *   upon NsmErrorStatus_e.          	The method is used by other applications to
...
_ErrorCode = deploy_ErrorCode.getValue();
    ...
    /**
     * description: SetBootMode:     	BootMode:   New BootMode to be set. The values will be
...
_ErrorCode = deploy_ErrorCode.getValue();
    ...
    /**
     * description: SetAppHealthStatus:     	AppName:    This parameter can be used to give the
     *   name of the application that has failed (this must be the applications systemd
     *   unit name).     	AppRunning: The AppState will be FALSE for failed and TRUE
     *   for running.     	ErrorCode:  Return value passed to the caller, based upon
     *   NsmErrorStatus_e.          	This method will be used by the Node Health
     ...
     *   if too many applications have failed.    		The method is used by other
     *   applications to request a restart of the node.
     * author: Giridhar
     */
...
_ErrorCode = deploy_ErrorCode.getValue();
    ...
    /**
     * description: CheckLucRequired:     	LucWanted: This will be a simple TRUE or FALSE to define
     *   whether the LUC is wanted in the current Lifecycle.         	This method will
