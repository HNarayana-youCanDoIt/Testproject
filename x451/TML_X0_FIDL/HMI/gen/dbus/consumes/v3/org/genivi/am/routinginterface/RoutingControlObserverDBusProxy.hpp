...
public:
     ...
     */
    virtual void sendShapingFilter(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, CommonAPI::CallStatus &_internalCallStatus, ::v3::org::genivi::am_t::am_Error_e &_qhError, const CommonAPI::CallInfo *_info);
    virtual std::future<CommonAPI::CallStatus> sendShapingFilterAsync(const ::v3::org::genivi::am_t::hq_shapingFilterStruct_param &_bsFilter, SendShapingFilterAsyncCallback _callback, const CommonAPI::CallInfo *_info);
    /**
