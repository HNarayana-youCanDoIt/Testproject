 ...
 * author: AYatheesh
 */
#include <v3/com/harman/audio/audioPresCtrl/audioPresCtrlSettingsDBusProxy.hpp>
...
,		fade_(*this, "onFadeAttributeChanged", "n", "getFadeAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		...
		userDefCustomValue_(*this, "onUserDefCustomValueAttributeChanged", "n", "getUserDefCustomValueAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		...
		beepStatus_(*this, "onBeepStatusAttributeChanged", "a{qb}", "getBeepStatusAttribute", static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::mBeepStatusDeployment_t*>(nullptr)),
		occupancyMode_(*this, "onOccupancyModeAttributeChanged", "i", "getOccupancyModeAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		uSBAutoPlayStatus_(*this, "onUSBAutoPlayStatusAttributeChanged", "b", "getUSBAutoPlayStatusAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		lastPlayedTunerSrc_(*this, "onLastPlayedTunerSrcAttributeChanged", "q", "getLastPlayedTunerSrcAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		lastPlayedMediaSrc_(*this, "onLastPlayedMediaSrcAttributeChanged", "q", "getLastPlayedMediaSrcAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr)),
		previousEntSource_(*this, "onPreviousEntSourceAttributeChanged", "q", "getPreviousEntSourceAttribute", static_cast<CommonAPI::EmptyDeployment*>(nullptr))
,		volumeChange_(*this, "VolumeChange", "(qq)b", std::make_tuple(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr))),
		volumeUpdate_(*this, "VolumeUpdate", "(qq)bi", std::make_tuple(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr))),
		sourceMuteState_(*this, "SourceMuteState", "qb", std::make_tuple(static_cast<CommonAPI::EmptyDeployment*>(nullptr), static_cast<CommonAPI::EmptyDeployment*>(nullptr)))
{
      ...
      audioPresCtrlSettingsDBusProxy::UserDefCustomValueAttribute& audioPresCtrlSettingsDBusProxy::getUserDefCustomValueAttribute() {
          return userDefCustomValue_;
      }
      ...
      audioPresCtrlSettingsDBusProxy::BeepStatusAttribute& audioPresCtrlSettingsDBusProxy::getBeepStatusAttribute() {
          return beepStatus_;
      }
      audioPresCtrlSettingsDBusProxy::OccupancyModeAttribute& audioPresCtrlSettingsDBusProxy::getOccupancyModeAttribute() {
          return occupancyMode_;
      }
      audioPresCtrlSettingsDBusProxy::USBAutoPlayStatusAttribute& audioPresCtrlSettingsDBusProxy::getUSBAutoPlayStatusAttribute() {
          return uSBAutoPlayStatus_;
      }
      audioPresCtrlSettingsDBusProxy::LastPlayedTunerSrcAttribute& audioPresCtrlSettingsDBusProxy::getLastPlayedTunerSrcAttribute() {
          return lastPlayedTunerSrc_;
      }
      audioPresCtrlSettingsDBusProxy::LastPlayedMediaSrcAttribute& audioPresCtrlSettingsDBusProxy::getLastPlayedMediaSrcAttribute() {
          return lastPlayedMediaSrc_;
      }
      audioPresCtrlSettingsDBusProxy::PreviousEntSourceAttribute& audioPresCtrlSettingsDBusProxy::getPreviousEntSourceAttribute() {
          return previousEntSource_;
      }

audioPresCtrlSettingsDBusProxy::VolumeChangeEvent& audioPresCtrlSettingsDBusProxy::getVolumeChangeEvent() {
    return volumeChange_;
}
audioPresCtrlSettingsDBusProxy::VolumeUpdateEvent& audioPresCtrlSettingsDBusProxy::getVolumeUpdateEvent() {
    return volumeUpdate_;
}
...
_internalCallStatus);
     ...
     */
    void audioPresCtrlSettingsDBusProxy::SetSourceVolume(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume &_volume, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors &_error, const CommonAPI::CallInfo *_info) {
        ...
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t> deploy_volume(_volume, static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
...
_error = deploy_error.getValue();
    ...
    std::future<CommonAPI::CallStatus> audioPresCtrlSettingsDBusProxy::SetSourceVolumeAsync(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume &_volume, SetSourceVolumeAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t> deploy_volume(_volume, static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr));
     ...
     */
    void audioPresCtrlSettingsDBusProxy::GetSourceVolume(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors &_error, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume &_volumeOfSource, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceID(_sourceID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t> deploy_volumeOfSource(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment>,
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume,::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t>
...
_volumeOfSource = deploy_volumeOfSource.getValue();
    ...
    std::future<CommonAPI::CallStatus> audioPresCtrlSettingsDBusProxy::GetSourceVolumeAsync(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceID, GetSourceVolumeAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceID(_sourceID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::sSourceVolume, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t> deploy_volumeOfSource(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::sSourceVolumeDeployment_t*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
...
_internalCallStatus);
     ...
     *   SourceMuteState
     */
    void audioPresCtrlSettingsDBusProxy::SetSourceMute(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceID, const bool &_mute, CommonAPI::CallStatus &_internalCallStatus) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceID(_sourceID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_internalCallStatus);
     ...
     */
    void audioPresCtrlSettingsDBusProxy::GetList(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eUserOption &_listType, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors &_error, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::ListItems &_list, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eUserOption, CommonAPI::EmptyDeployment> deploy_listType(_listType, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::ListItems, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::ListItemsDeployment_t> deploy_list(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::ListItemsDeployment_t*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eUserOption, CommonAPI::EmptyDeployment >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment>,
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::ListItems,::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::ListItemsDeployment_t>
            >
        	>::callMethodWithReply(
        *this,
        "GetList",
...
_list = deploy_list.getValue();
    ...
    std::future<CommonAPI::CallStatus> audioPresCtrlSettingsDBusProxy::GetListAsync(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eUserOption &_listType, GetListAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eUserOption, CommonAPI::EmptyDeployment> deploy_listType(_listType, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::ListItems, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::ListItemsDeployment_t> deploy_list(static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::ListItemsDeployment_t*>(nullptr));
        return CommonAPI::DBus::DBusProxyHelper<
    ...
    void audioPresCtrlSettingsDBusProxy::GetSourceMute(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceID, CommonAPI::CallStatus &_internalCallStatus, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors &_error, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceId, bool &_mute, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceID(_sourceID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceId(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_mute = deploy_mute.getValue();
    ...
    std::future<CommonAPI::CallStatus> audioPresCtrlSettingsDBusProxy::GetSourceMuteAsync(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId &_sourceID, GetSourceMuteAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eAudioPresErrors, CommonAPI::EmptyDeployment> deploy_error(static_cast<CommonAPI::EmptyDeployment *>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceID(_sourceID, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::SourceId, CommonAPI::EmptyDeployment> deploy_sourceId(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::Deployable<bool, CommonAPI::EmptyDeployment> deploy_mute(static_cast<CommonAPI::EmptyDeployment*>(nullptr));
...
_internalCallStatus);
     ...
     */
    void audioPresCtrlSettingsDBusProxy::setAudioAttribute(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::mAttribute &_attributesmap, CommonAPI::CallStatus &_internalCallStatus) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::mAttribute, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::mAttributeDeployment_t> deploy_attributesmap(_attributesmap, static_cast<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::mAttributeDeployment_t*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::mAttribute, ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes_::mAttributeDeployment_t >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
            >
        	>::callMethod(
...
_internalCallStatus);
     ...
     */
    void audioPresCtrlSettingsDBusProxy::ResetAudioSettings(const ::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eResetType &_resetType, CommonAPI::CallStatus &_internalCallStatus) {
        CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eResetType, CommonAPI::EmptyDeployment> deploy_resetType(_resetType, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<::v3::com::harman::audio::audioPresCtrl::audioPresCtrlTypes::eResetType, CommonAPI::EmptyDeployment >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
            >
        	>::callMethod(
...
_internalCallStatus);
     ...
     */
    void audioPresCtrlSettingsDBusProxy::SetCustomPreset(const int16_t &_frequencyBandValue, CommonAPI::CallStatus &_internalCallStatus) {
        CommonAPI::Deployable<int16_t, CommonAPI::EmptyDeployment> deploy_frequencyBandValue(_frequencyBandValue, static_cast<CommonAPI::EmptyDeployment*>(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable<int16_t, CommonAPI::EmptyDeployment >
            >,
